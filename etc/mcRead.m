...
if isempty(strfind(title{1,1},'MC_DataTool ASCII conversion')) % Verifies the .txt file came from MC_DataTool
...
for i=2:ncol
    format.label{i} = strtrim(head{1}{1}(13*(i-1)+1:13*(i-1)+12));
end
